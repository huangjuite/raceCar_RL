...
class DeepQNetwork:
    ...
    def _build_net(self):
        # ------------------ build evaluate_net ------------------
        self.s = tf.placeholder(tf.float32, self.features, name='s')  # input
        ...
        with tf.variable_scope('eval_net'):
            ...
            with tf.variable_scope('conv1'):
                k1 = tf.get_variable('k1', [5,5,3,16], initializer=w_initializer, collections=c_names)
            ...
            with tf.variable_scope('fc1'):
                #96/4/2 = 12
                w3 = tf.get_variable('w3', [12*12*32, 10], initializer=w_initializer, collections=c_names)
                b3 = tf.get_variable('b3', [1,10], initializer=b_initializer,collections=c_names)
                l3 = tf.nn.relu(tf.matmul(flat,w3) + b3)
        ...
        # ------------------ build target_net ------------------
        self.s_ = tf.placeholder(tf.float32, self.features, name='s_')    # input
